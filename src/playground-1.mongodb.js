...
db.getCollection('satellites').insertMany([
  ...
  },
  {
    ...
    type: "simulated",
    createdAt: ISODate("2025-05-28T00:00:00Z")
  },
  {
...
db.getCollection('tle').insertMany([
  ...
  },
  {
    ...
    line1: "1 99901U 24001A   25148.00000000  .00000023  00000-0  00000-0 0  9992",
    line2: "2 99901  51.6416 156.1234 0006703 230.4562 129.5573 15.49637626216588",
    epoch: ISODate("2025-05-28T00:00:00Z"),
    source: "simulated",
    createdAt: ISODate("2025-05-28T00:00:00Z")
  },
  {
    ...
    line1: "1 99902U 24002A   25148.00000000  .00000025  00000-0  00000-0 0  9993",
...
db.getCollection('ground_stations').insertMany([
  {
    ...
    location: { lat: 37.940, lon: -75.466, alt: 0 },
    band: ["UHF", "S-Band"],
    createdAt: ISODate("2024-05-23T12:00:00Z")
  },
  {
    ...
    location: { lat: 35.000, lon: -80.000, alt: 0 },
    band: ["VHF", "X-Band"],
    createdAt: ISODate("2024-05-23T12:00:00Z")
  }
]);

// Insert contact windows
