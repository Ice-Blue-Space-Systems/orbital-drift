...
export const themes: Record<string, Theme> = {
  matrix: {
    ...
    success: "#00ff41",
    error: "#ff4444",
    background: "linear-gradient(135deg, rgba(10, 15, 10, 0.95) 0%, rgba(15, 25, 15, 0.90) 100%)",
    backgroundDark: "rgba(10, 15, 10, 0.95)",
    ...
    // App-wide properties
    appBackground: "linear-gradient(135deg, #0a0f0a 0%, #141a14 50%, #0a0f0a 100%)",
    cardBackground: "rgba(5, 20, 10, 0.8)",
    navBackground: "rgba(10, 15, 10, 0.95)",
    textPrimary: "#00ff41",
    textSecondary: "#aaa",
